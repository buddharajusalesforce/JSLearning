...
/*2. The first player in any player array is the wicketkeeper and the 
others are field players. For India (team 1) create one variable ('Ind') 
with the wicketkeeper name, and one array ('fieldPlayers') 
with all the remaining 10 field players
*/
let [captain, ...fieldPlayers] = players1; //rest operator
...
/*4. During the game, India (team 1) used 3 substitute players. 
So create a new array ('players1Final') containing all the original 
team1 players plus 'Sandeep', 'John' and 'Sunil'
*/
...
//console.log(team1);
let { team1, x: draw, team2 } = game.odds; //alias draw for x
...
console, along with the Century number (Example: "Century 1: Kohli")
*/
for (let [currItem, value] of game.Century.entries()) {
  console.log(`Century ${currItem + 1}: ${value}`);
}
